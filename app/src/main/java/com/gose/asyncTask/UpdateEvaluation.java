 ...
 */
public class UpdateEvaluation extends AsyncTask<String, Integer, String> {
    ...
    public UpdateEvaluation(Context context, String government_id, String user_id, float rating){
    ...
    protected String doInBackground(String... params) {
        ...
        String url = "http://gose.esy.es/administrator/json/update_evaluation.html";
