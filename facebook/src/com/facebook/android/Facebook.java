...
public class Facebook {
    ...
    private class SetterTokenCachingStrategy extends TokenCachingStrategy {
        ...
        public Bundle load() {
            ...
            if (accessToken != null) {
                putToken(bundle, accessToken);
                putExpirationMilliseconds(bundle, accessExpiresMillisecondsAfterEpoch);
                putPermissions(bundle, stringList(pendingAuthorizationPermissions));
                putSource(bundle, AccessTokenSource.WEB_VIEW);
                putLastRefreshMilliseconds(bundle, lastAccessUpdateMillisecondsAfterEpoch);
            }
        ...
        public void save(Bundle bundle) {
            accessToken = getToken(bundle);
            accessExpiresMillisecondsAfterEpoch = getExpirationMilliseconds(bundle);
            pendingAuthorizationPermissions = stringArray(getPermissions(bundle));
            lastAccessUpdateMillisecondsAfterEpoch = getLastRefreshMilliseconds(bundle);
        }
